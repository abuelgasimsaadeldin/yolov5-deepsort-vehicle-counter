...
def plot_counter(img, label, org):
    ...
    (label_width, label_height) = cv2.getTextSize(label, font, fontScale=fontScale, thickness=2)[0]
    box_coords = ((org[0]-3, org[1]+8), (org[0] + label_width - 1, org[1] - label_height - 4)) # -3=left side, +8=down space
    cv2.rectangle(img, box_coords[0], box_coords[1], rectangle_bgr, cv2.FILLED)            # -1=space after comma,
    color = (0,0,0)                                                                        # -4=white extension up
    thickness = 2
    ...
    def box_label(self, box, label='', color=(128, 128, 128), txt_color=(255, 255, 255)):
        ...
        if self.pil or not is_ascii(label):
            ...
            if label:
                ...
                cv2.circle(self.im, (xc, yc), 4, color, -1)
