...
from utils.plots import plot_one_box, plot_counter
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or view_img:
                        ...
                        #label2 = '%s: %d' % (names[int(cls)], n)
                        #plot_counter(im0, label2=label2)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='vehicles.pt', help='model.pt path(s)')
