...
def run(weights='vehicles2.pt',  # model.pt path(s)
        source='data/vehicle_test_videos/live.mp4',  # file/dir/URL/glob, 0 for webcam
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='data/vehicle_test_videos/live.mp4', help='0 for webcam')
    ...
    parser.add_argument('--project', default='runs/result-detect', help='save results to project/name')
